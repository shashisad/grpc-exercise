...
type GreetService_GreetEveryoneClient interface {
	...
	Recv() (*GreetEveryoneReponse, error)
	grpc.ClientStream
}
...
func (x *greetServiceGreetEveryoneClient) Recv() (*GreetEveryoneReponse, error) {
	m := new(GreetEveryoneReponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GreetService_GreetEveryoneServer interface {
	Send(*GreetEveryoneReponse) error
...
func (x *greetServiceGreetEveryoneServer) Send(m *GreetEveryoneReponse) error {
	return x.ServerStream.SendMsg(m)
}
